...
class ProgressBar:
    def __init__(self, initial_message, file_info, logger, download_dir, file_size, start_time, origin_group):
    ...
    async def progress_callback(self, current, total):
        ...
        if percentage - self.last_percentage_sent >= 20 or percentage == 100:
